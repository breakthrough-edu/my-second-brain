...
One home, two wings: personal life in PARA (`02_Projects` to `05_Archive`), the business in a three-layer map under `07_{{BUSINESS}}/` (01_Assets: what it is made of · 02_SOP: how things get done · 03_Methodology: why decisions go the way they go, filled only from the owner's reviewed judgment). Built and run with the `my-second-brain` skill.

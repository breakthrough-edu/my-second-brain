...
One line on what they just got, no more, and ⛔ without a count: "A few more skills came with this one. Say 'help me plan this project' when a piece of work is big enough to need thinking through, 'wrap up' when a working session ends and what it taught should be written down, `breakthrough-method-builder` by name when a whole job closes and how you did it is worth keeping, or when several of those turn out to be one way of working and you want them written up as a playbook, and 'change the doctrine' the day your vault's own rules need to change."
